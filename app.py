...
def api_salvar_stock():
    ...
    try:
        ...
        tipo = dados.get("tipo_movimentacao")
        ...
        cur.execute("""
            ...
            DO UPDATE SET
                ...
                produto_uuid = EXCLUDED.produto_uuid,
                armazem_uuid = EXCLUDED.armazem_uuid,
...
def api_compras():
    ...
    try:
        ...
        print("✔ COMPRA SALVA:", compra_uuid)
